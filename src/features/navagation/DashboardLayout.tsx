...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <aside className={`${sidebarExpanded ? 'w-72' : 'w-20'} bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transition-all duration-300 ease-in-out flex flex-col`}>
        <Logo />
      ...
      <div className="relative flex flex-1 flex-col overflow-y-auto bg-gray-50 dark:bg-gray-950">
