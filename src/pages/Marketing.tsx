  ...
  return (
    <div className="p-4 md:p-6 space-y-6 bg-gray-50/50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm border-l-4 border-l-blue-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-blue-200">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Total Ad Budget</p>
          <div className="flex justify-between items-baseline mt-2">
            <h4 className="text-2xl font-bold text-gray-800 tracking-tight">$12,450</h4>
            <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-100">+8.2%</span>
          </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm border-l-4 border-l-indigo-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-indigo-200">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Click-Through Rate</p>
          <div className="flex justify-between items-baseline mt-2">
            <h4 className="text-2xl font-bold text-gray-800 tracking-tight">4.65%</h4>
            <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-100">+1.2%</span>
          </div>
          <div className="mt-4 flex items-center gap-2 text-xs text-gray-400">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm border-l-4 border-l-sky-400 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-sky-200">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Average ROI</p>
          <div className="flex justify-between items-baseline mt-2">
            <h4 className="text-2xl font-bold text-gray-800 tracking-tight">3.8x</h4>
            <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-100">+0.5x</span>
          </div>
          <div className="mt-4 flex items-center gap-2 text-xs text-gray-400">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm border-l-4 border-l-blue-400 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-blue-200">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Total Conversions</p>
          <div className="flex justify-between items-baseline mt-2">
            <h4 className="text-2xl font-bold text-gray-800 tracking-tight">1,240</h4>
            <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-100">+14.6%</span>
          </div>
          <div className="mt-4 flex items-center gap-2 text-xs text-gray-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-md">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-lg font-bold text-gray-800 tracking-tight">Daily Ad Spend vs Return</h3>
              <p className="text-sm text-gray-400">Comparing capital allocation against daily ROI</p>
            </div>
            <button className="p-2 rounded-xl text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={marketingBarData}>
                ...
                <Tooltip 
                  ...
                  contentStyle={{ backgroundColor: '#ffffff', borderRadius: '1rem', border: '1px solid #f3f4f6', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.05)' }} 
                />
        ...
        {/* Channel Share Donut */}
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between transition-all duration-300 hover:shadow-md">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-lg font-bold text-gray-800 tracking-tight">Channel Spend Share</h3>
          ...
          <div className="h-44 relative flex items-center justify-center my-2">
            ...
            <div className="absolute text-center pointer-events-none">
              ...
              <span className="text-xl font-extrabold text-gray-800">45%</span>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-2.5 pt-4 border-t border-gray-100">
            {channelShareData.map((item) => (
              <div key={item.name} className="flex items-center gap-2 p-1.5 rounded-xl transition-colors hover:bg-gray-50">
      ...
      <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-md">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h3 className="text-lg font-bold text-gray-800 tracking-tight">Campaign Deployments</h3>
            <p className="text-sm text-gray-400">Live operational promotional slots</p>
          </div>
          <span className="text-xs font-bold text-blue-600 bg-blue-50 px-3.5 py-1.5 rounded-full border border-blue-100">4 Active Campaigns</span>
        </div>
          ...
          {[
            ...
            <div 
              ...
              className={`p-5 rounded-2xl border transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lg ${
                ...
                camp.status === 'Active' 
                  ? 'border-gray-100 bg-gradient-to-b from-white to-gray-50/50 hover:border-blue-200 hover:shadow-blue-500/5' 
                  : 'border-dashed border-gray-200 bg-gray-50/30 hover:border-gray-300'
              }`}
            >
              <div className="flex justify-between items-start mb-3">
                <span className="text-[10px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-lg bg-blue-50 text-blue-600 border border-blue-100/50">
                  {camp.platform}
                </span>
                {camp.status === 'Active' ? (
                  <span className="flex items-center gap-1 text-xs font-bold text-green-600 bg-green-50 px-2.5 py-0.5 rounded-full border border-green-100">
              ...
              <h4 className="text-sm font-bold text-gray-800 mb-1 line-clamp-1 tracking-tight">{camp.name}</h4>
              
              <div className="my-3.5 space-y-2 text-xs">
                <div className="flex justify-between text-gray-400">
                  <span>Spent: <strong className="text-gray-700">{camp.spent}</strong></span>
                  <span>Budget: {camp.budget}</span>
                </div>
                <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden p-0.5 border border-gray-200/60">
              ...
              <div className="flex justify-between items-center pt-3.5 border-t border-gray-100 text-xs">
                ...
                <span className="font-extrabold text-gray-800 bg-white px-2.5 py-1 rounded-xl shadow-xs border border-gray-100">{camp.roi}</span>
              </div>
            </div>
          ))}
        </div>
